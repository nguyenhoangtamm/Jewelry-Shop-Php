...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-blue-900 via-indigo-800 to-cyan-700 text-white">
        ...
        <div class="relative container mx-auto px-4 py-16">
            <!-- Breadcrumb -->
            <nav class="mb-8">
                <ol class="flex items-center space-x-3 text-sm text-blue-200">
                    <li><a href="{{ route('home') }}" class="hover:text-white transition-colors">Trang chủ</a></li>
                    <li class="text-blue-300">/</li>
                    <li class="text-white font-medium">Sản phẩm mới</li>
                </ol>
            </nav>
                    ...
                    <div class="col-span-full">
                        <div class="text-center py-16 bg-white rounded-2xl shadow-lg border border-gray-100">
                            <div class="max-w-md mx-auto">
                                ...
                                <p class="text-gray-600 mb-6">Thử thay đổi bộ lọc hoặc tìm kiếm với từ khóa khác để khám phá những món trang sức tuyệt vời.</p>
                                <button class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-indigo-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                                    Xem tất cả sản phẩm
                                </button>
                            </div>
                        </div>
