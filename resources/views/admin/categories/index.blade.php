...
@section('content')
    <style>
        * {
        ...
        .modal-container, .modal-delete-container {
        ...
        .modal-close, .modal-delete-close {
            position: absolute;
            top: 15px;
            right: 15px;
        ...
        .modal-close:hover, .modal-delete-close:hover {
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="fa-solid fa-pen icon-change js-changeCategory"
                            ...
                            data-category-description="{{ $category->description }}"></button>
